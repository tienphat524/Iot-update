...
var Pt = class {
  constructor(t, e) {
    this.action = t, this.transaction = e, this.aborted = false, this.R = new K2(), this.transaction.oncomplete = () => {
      this.R.resolve();
  ...
  async runTransaction(t, e, n, s) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        const e2 = Pt.open(this.db, t, i ? "readonly" : "readwrite", n), r3 = s(e2).next((t2) => (e2.P(), t2)).catch((t2) => (e2.abort(t2), vt.reject(t2))).toPromise();
        return r3.catch(() => {
        }), await e2.v, r3;
      } catch (t2) {
...
var br = class {
  ...
  we(t, e) {
    if ("nullValue" in t)
      ...
      isNaN(n) ? this.ge(e, 13) : (this.ge(e, 15), Bt(n) ? e.ye(0) : e.ye(n));
...
var Jr = class {
  constructor(t, e) {
    this.user = t, this.databaseId = e, this.rn = new Wr(), this.on = new os((t2) => On(t2), (t2, e2) => $n(t2, e2)), this.uid = t.uid || "";
  }
  addToCollectionParentIndex(t, e) {
    if (!this.rn.has(e)) {
...
var oo = class {
  constructor(t, e, n, s) {
    this.userId = t, this.serializer = e, this.indexManager = n, this.referenceDelegate = s, this.bn = {};
  }
  static fe(t, e, n, s) {
    F2("" !== t.uid);
...
var Eo = class {
  ...
  Jn(t, e) {
    ...
    return n.X({
      ...
      0 === t2 ? (i !== $t.ct && e(new ht(Gt(s)), i), i = o, s = r2) : i = $t.ct;
    }).next(() => {
...
var bo = class extends Ro {
  constructor(t, e) {
    super(), this.rs = t, this.trackRemovals = e, this.os = new os((t2) => t2.toString(), (t2, e2) => t2.isEqual(e2));
  }
  applyChanges(t) {
    const e = [];
  ...
  getAllFromCache(t, e) {
    return this.rs.ns(t, e).next(({ documents: t2, ss: e2 }) => (e2.forEach((e3, n) => {
      this.os.set(e3, {
        size: n,
...
var Jo = class {
  constructor(t, e, n, s, i, r2, o, u, c, a, h = 15) {
    if (this.allowTabSynchronization = t, this.persistenceKey = e, this.clientId = n, this.si = i, this.window = r2, this.document = o, this.ii = c, this.ri = a, this.oi = h, this.Os = null, this.$s = false, this.isPrimary = false, this.networkEnabled = true, this.ui = null, this.inForeground = false, this.ci = null, this.ai = null, this.hi = Number.NEGATIVE_INFINITY, this.li = (t2) => Promise.resolve(), !Jo.D())
  ...
  setNetworkEnabled(t) {
    this.networkEnabled !== t && (this.networkEnabled = t, this.si.enqueueAndForget(async () => {
  ...
  async shutdown() {
    this.$s = false, this.Ci(), this.ai && (this.ai.cancel(), this.ai = null), this.xi(), this.Ni(), await this.di.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (t) => {
      const e = new _e(t, $t.ct);
      return this.Ei(e).next(() => this.vi(e));
    }), this.di.close(), this.ki();
  }
  Vi(t, e) {
  ...
  gi() {
    ...
    "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ui = () => {
      ...
      isSafari() && (navigator.appVersion.match(t2) || navigator.userAgent.match(t2)) && this.si.enterRestrictedMode(true), this.si.enqueueAndForget(() => this.shutdown());
...
var Pu = class {
  constructor(t, e, n, s, i) {
    this.window = t, this.si = e, this.persistenceKey = n, this.dr = s, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this._r = this.wr.bind(this), this.mr = new pe(et), this.started = false, this.gr = [];
    const r2 = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.yr = yu(this.persistenceKey, this.dr), this.pr = function(t2) {
      return `firestore_sequence_number_${t2}`;
    }(this.persistenceKey), this.mr = this.mr.insert(this.dr, new vu()), this.Ir = new RegExp(`^firestore_clients_${r2}_([^_]*)$`), this.Tr = new RegExp(`^firestore_mutations_${r2}_(\\d+)(?:_(.*))?$`), this.Er = new RegExp(`^firestore_targets_${r2}_(\\d+)$`), this.Ar = function(t2) {
  ...
  async start() {
    ...
    for (const t2 of this.gr)
      this.wr(t2);
    this.gr = [], this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
    ...
    return d(a, WebChannel.EventType.OPEN, () => {
      ...
      if (!l2) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = q2.INTERNAL, i3 = "Unknown error status: " + e3 + " with message " + o2.message), l2 = true, f.fo(new U2(n3, i3)), a.close();
        } else
...
var Bu = class {
  ...
  xo(t) {
    ...
    s > 0 && N2("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Vo} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.So = this.si.enqueueAfterDelay(this.timerId, s, () => (this.Do = Date.now(), t())), this.Vo *= this.Po, this.Vo < this.vo && (this.Vo = this.vo), this.Vo > this.bo && (this.Vo = this.bo);
  }
  ko() {
...
var Lu = class {
  ...
  async close(t, e) {
    this.Wo(), this.Ho(), this.Lo.cancel(), this.$o++, 4 !== t ? this.Lo.reset() : e && e.code === q2.RESOURCE_EXHAUSTED ? (k2(e.toString()), k2("Using maximum backoff delay to prevent overloading the backend."), this.Lo.Co()) : e && e.code === q2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.Jo(), this.stream.close(), this.stream = null), this.state = t, await this.listener.co(e);
  }
  Jo() {
  }
  auth() {
...
var Uu = class extends Lu {
  ...
  onMessage(t) {
    if (F2(!!t.streamToken), this.lastStreamToken = t.streamToken, this.iu) {
      this.Lo.reset();
...
async function Gu(t, e, n) {
  ...
  const c = (await i.Ao("RunAggregationQuery", u, r2, 1)).filter((t2) => !!t2.result);
  F2(1 === c.length);
...
function Hu(t, e) {
  const n = L(t);
  n.Eu.has(e.targetId) || (n.Eu.set(e.targetId, e), tc2(n) ? Zu(n) : pc2(n).Uo() && Yu(n, e));
}
function Ju(t, e) {
  const n = L(t), s = pc2(n);
  n.Eu.delete(e), s.Uo() && Xu(n, e), 0 === n.Eu.size && (s.Uo() ? s.Qo() : ec2(n) && n.Pu.set("Unknown"));
}
function Yu(t, e) {
...
async function ic2(t, e) {
  nc2(t), tc2(t) ? (t.Pu.pu(e), Zu(t)) : t.Pu.set("Unknown");
}
...
async function oc2(t, e, n) {
  ...
  t.Au.add(1), await Wu(t), t.Pu.set("Offline"), n || (n = () => ou(t.localStore)), t.asyncQueue.enqueueRetryable(async () => {
    N2("RemoteStore", "Retrying IndexedDB access"), await n(), t.Au.delete(1), await zu(t);
  });
}
function uc2(t, e) {
...
async function mc2(t, e) {
  e && Ic2(t).ru && await async function(t2, e2) {
    if (n = e2.code, oi(n) && n !== q2.ABORTED) {
      const n2 = t2.Tu.shift();
      Ic2(t2).Go(), await uc2(t2, () => t2.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), await cc2(t2);
    }
    var n;
  }(t, e), lc2(t) && fc2(t);
}
...
function pc2(t) {
  return t.Vu || (t.Vu = function(t2, e, n) {
    ...
    e ? (t.Vu.Go(), tc2(t) ? Zu(t) : t.Pu.set("Unknown")) : (await t.Vu.stop(), nc2(t));
  })), t.Vu;
}
function Ic2(t) {
  return t.Su || (t.Su = function(t2, e, n) {
    ...
    e ? (t.Su.Go(), await cc2(t)) : (await t.Su.stop(), t.Tu.length > 0 && (N2("RemoteStore", `Stopping write stream with ${t.Tu.length} pending writes`), t.Tu = []));
  })), t.Su;
}
var Tc2 = class {
  constructor(t, e, n, s, i) {
...
var Oc2 = class {
  constructor(t, e, n) {
    this.Qu = t, this.localStore = e, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = $c2(t);
  }
  ju(t) {
...
var Lc2 = class {
  constructor(t, e) {
    this.query = t, this.Ju = e, this.Yu = null, this.hasCachedResults = false, this.current = false, this.Xu = gs(), this.mutatedKeys = gs(), this.Zu = is(t), this.tc = new Ac2(this.Zu);
  }
  get ec() {
    return this.Ju;
  }
...
async function Wc2(t, e) {
  ...
  try {
    ...
    e.targetChanges.forEach((t3, e2) => {
      const s = n.gc.get(e2);
      s && (F2(t3.addedDocuments.size + t3.modifiedDocuments.size + t3.removedDocuments.size <= 1), t3.addedDocuments.size > 0 ? s.lc = true : t3.modifiedDocuments.size > 0 ? F2(s.lc) : t3.removedDocuments.size > 0 && (F2(s.lc), s.lc = false));
    }), await ua2(n, t2, e);
  } catch (t2) {
    await Rt(t2);
  }
...
async function Jc2(t, e, n) {
  ...
  if (r2) {
    ...
    await Wc2(s, i2), s.mc = s.mc.remove(r2), s.gc.delete(e), oa2(s);
  } else
    await lu(
      s.localStore,
      e,
...
function ia(t, e, n) {
  for (const s of n)
    if (s instanceof Fc2)
      ...
      t.yc.containsKey(s.key) || sa2(t, s.key);
    } else
      $();
}
function ra2(t, e) {
...
async function ca2(t, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(e, t2.removedBatchIds, t2.addedBatchIds), await ua2(n, t2.tr);
  }
}
function aa2(t, e) {
...
async function fa2(t, e, n, s) {
  ...
  }(i.localStore, e)) : $(), await ua2(i, r2)) : N2("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
async function da2(t, e) {
  ...
  if (pa2(n), Ia2(n), true === e && true !== n.Ac) {
    ...
    }), await e2, await _a(n, t2), function(t3) {
      const e3 = L(t3);
      e3.gc.forEach((t4, n2) => {
...
var Ra2 = class extends Ea {
  ...
  async initialize(t) {
    await super.initialize(t), await this.bc.initialize(this, t), await Ia2(this.bc.syncEngine), await cc2(this.bc.remoteStore), await this.persistence.pi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(t) {
    return su(this.persistence, new eu(), t.initialUser, this.serializer);
  }
...
var va2 = class extends Ra2 {
  constructor(t, e) {
    super(t, e, false), this.bc = t, this.cacheSizeBytes = e, this.synchronizeTabs = true;
  }
  async initialize(t) {
    ...
    this.sharedClientState instanceof Pu && (this.sharedClientState.syncEngine = {
      ...
      Mi: ma2.bind(null, e),
      Gr: la.bind(null, e)
    }, await this.sharedClientState.start()), await this.persistence.pi(async (t2) => {
...
var Pa2 = class {
  ...
  terminate() {
    return async function(t) {
      const e = L(t);
      N2("RemoteStore", "RemoteStore shutting down."), e.Au.add(5), await Wu(e), e.vu.shutdown(), e.Pu.set("Unknown");
    }(this.remoteStore);
  }
};
...
var Sa2 = class {
  constructor(t, e) {
    this.Dc = t, this.serializer = e, this.metadata = new K2(), this.buffer = new Uint8Array(), this.Cc = new TextDecoder("utf-8"), this.xc().then((t2) => {
...
var Ca2 = class {
  constructor(t, e, n, s, i) {
    this.asyncQueue = t, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.Fc = n.maxAttempts, this.Lo = new Bu(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Fc -= 1, this.Bc();
  }
...
function Qa2(t) {
  return t.asyncQueue.enqueue(async () => {
    ...
    return e.setNetworkEnabled(false), async function(t2) {
      const e2 = L(t2);
      e2.Au.add(0), await Wu(e2), e2.Pu.set("Offline");
    }(n);
  });
}
function ja2(t, e) {
...
function Nl(t) {
  return uh("limit", t), xl._create("limit", t, "F");
}
function kl(t) {
  return uh("limitToLast", t), xl._create("limitToLast", t, "L");
}
      ...
      for (const t3 of e2.indexes) {
        ...
        if (Array.isArray(t3.fields))
          for (const e4 of t3.fields) {
            ...
            "CONTAINS" === e4.arrayConfig ? s2.push(new wt(t4, 2)) : "ASCENDING" === e4.order ? s2.push(new wt(t4, 0)) : "DESCENDING" === e4.order && s2.push(new wt(t4, 1));
          }
...
* limitations under the License.
*/
//# sourceMappingURL=chunk-M6DUYAFO.js.map
